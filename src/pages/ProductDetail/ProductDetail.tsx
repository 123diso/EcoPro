...
import type { Product, DandiPoint } from "../../types";
import productsRaw from "../../assets/productCards.json"; // ajusta el nombre si cambia
...
export default function ProductDetail() {
  ...
  // Busca el punto Dandi por texto en location (ej. "Valle de Lilí")
  ...
  // Puntos cercanos (si encontró el principal)
    ...
    <main className="prod-layout">
      ...
      <section className="prod-left">
        ...
        <div className="actions">
          <button className="btn-primary">Hacer trueque</button>
